...
const About = () => {
  return (
    <section name="About" className='w-full min-h-screen sm:h-[110vh] bg-[#0a192f] text-[#ccd6f6]'>
       <div className='w-[90%] mx-auto flex flex-col justify-center h-screen px-6'>
        <h1 className='text-3xl sm:text-5xl border-b-pink-600 border-b-4 pb-1 w-fit mb-2 sm:mb-4'>About</h1>
        <p className='text-2xl sm:text-4xl mb-1 text-[#8892b0]'>
